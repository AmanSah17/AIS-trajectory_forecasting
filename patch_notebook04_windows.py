"""
patch_notebook04_windows.py
==========================
Patches cells 2 (paths), 6 (data loading), 13 (max epochs), 26 (early stopping)
in 04_TRAISformer_Q1.ipynb for Windows and 150 epochs.
"""
import json
...
NB_PATH = Path(
    ...
    r"\CEE-Replication\Geohashed_traisformer\Notebooks\04_TRAISformer_Q1.ipynb"
)
...
print("\nNotebook 04 patched successfully.")
